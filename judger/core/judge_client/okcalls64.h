...
//c & c++
int LANG_CV[1024] = {0,1,2,3,4,5,8,9,11,12,14,20,21,59,63,89,99,158,186,231,234,240,252,
		SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
		SYS_close, SYS_execve, SYS_access, SYS_brk, SYS_munmap, SYS_mprotect,
		SYS_mmap, SYS_fstat, SYS_set_thread_area,SYS_arch_prctl, 0 };
//pascal
int LANG_PV[1024] = {0,1,2,3,4,9,11,13,16,59,89,97,158,191,201,231,252,
...
//java
int LANG_JV[1024] = { 0,2,3,4,5,6,8,9,10,11,12,13,14,16,21,22,33,39,56,59,61,79,89,97,104,
		110,111,158,202,218,231,273,257,302, 
		SYS_fcntl,
...
//ruby
int LANG_RV[1024] = { 0,1,2,3,4,5,6,9,10,12,13,14,16,20,21,22,56,59,72,79,96,97,98,107,
		108,126,131,158,202,218,228,231,273,293,302,318,340,
...
//bash
int LANG_BV[1024] = { 0,1,2,3,4,5,8,9,10,12,13,14,16,21,22,33,39,41,42,56,59,
		60,61,63,72,79,96,97,99,102,104,107,108,110,111,117,158,183,191,231,302,            
		SYS_access, SYS_arch_prctl, SYS_brk, SYS_close, SYS_dup2,
		...
		SYS_stat, SYS_uname, SYS_write,  0 };
//python
int LANG_YV[1024] = {0,1,2,3,4,5,6,8,9,10,11,12,13,14,16,20,21,32,39,41,42,59,60,72,78,79,
		89,97,99,102,104,107,108,117,131,146,158,191,202,218,231,257,273,302,318,
		SYS_mremap,      
...
//c-sharp
int LANG_CSV[1024] = {0,1,2,3,4,5,8,9,10,11,12,13,14,16,21,24,39,41,42,56,59,60,63,64,65,66,72,78,79,83,89,95,97,
		102,117,131,137,141,157,158,191,202,204,218,229,231,234,257,273,257,302,
		SYS_access, SYS_brk, SYS_chmod, SYS_clock_getres,
...
//scheme
int LANG_SV[1024] = { 0,1,2,3,4,5,8,9,10,11,12,13,14,16,21,56,59,72,97,158,202,204,218,228,229,234,273,293,
...
//go-lang
int LANG_GOV[1024]={0,1,9,11,13,14,56,59,131,158,186,202,204,231,267,0};
